...
function GeneralEducation(currNameId){
  ...
  var query = firebase.database().ref("MI/"+currNameId+"/Course/").orderByChild("Ccode");
...
function CdeleteOnClick(trKey,currNameId){
  ...
  $(document).ready(function(){
    ...
    var firebaseRef = firebase.database().ref("MI/"+currNameId+"/Course/"+trKey);
...
function MajorEducation(currNameId){
  ...
  var fragment = document.createDocumentFragment();
  var table = document.createElement("table");
  var query = firebase.database().ref("MI/"+currNameId+"/MajorCourse/").orderByChild("Ccode");
...
function MdeleteOnClick(trKey, currNameId){
  ...
  $(document).ready(function(){
    ...
    var firebaseRef = firebase.database().ref("MI/"+currNameId+"/MajorCourse/"+trKey);
...
function addCourse(){
  ...
  if(intCheck == 1){
    ...
    var firebaseRef=firebase.database().ref("MI/"+currNameIdGlobal+"/Course/");
...
function addMCourse(){
  ...
  if(intCheck == 1){
    ...
    var firebaseRef=firebase.database().ref("MI/"+currNameIdGlobal+"/MajorCourse/");
...
function addNewCurriculum(){
  ...
  if(intCheck == 1){
    ...
    var firebaseRef=firebase.database().ref("MI/"+AddCurrNameId+"/Info/");
...
function getCurrId(){
  ...
  var query = firebase.database().ref("MI");
...
function getCurrName(currNameId,i){
  ...
  var query = firebase.database().ref("MI/"+currNameId+"/Info/");
