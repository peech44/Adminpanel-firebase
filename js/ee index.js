...
function GeneralEducation(currNameId){
  ...
  var query = firebase.database().ref("EE/"+currNameId+"/Course/").orderByChild("Ccode");
...
function CdeleteOnClick(trKey,currNameId){
  ...
  $(document).ready(function(){
    ...
    var firebaseRef = firebase.database().ref("EE/"+currNameId+"/Course/"+trKey);
...
function MajorEducation(currNameId){
  ...
  var fragment = document.createDocumentFragment();
  var table = document.createElement("table");
  var query = firebase.database().ref("EE/"+currNameId+"/MajorCourse/").orderByChild("Ccode");
...
function MdeleteOnClick(trKey, currNameId){
  ...
  $(document).ready(function(){
    ...
    var firebaseRef = firebase.database().ref("EE/"+currNameId+"/MajorCourse/"+trKey);
...
function addCourse(){
  ...
  if(intCheck == 1){
    ...
    var firebaseRef=firebase.database().ref("EE/"+currNameIdGlobal+"/Course/");
...
function addMCourse(){
  ...
  if(intCheck == 1){
    ...
    var firebaseRef=firebase.database().ref("EE/"+currNameIdGlobal+"/MajorCourse/");
...
function addNewCurriculum(){
  ...
  if(!AddCurrNameId){
    ...
    intCheck = 2;
    alert("Curriculum id จะต้องมี 2 ตัวเลข เช่น 0001,0002");
  ...
  if(intCheck == 1){
    ...
    var firebaseRef=firebase.database().ref("EE/"+AddCurrNameId+"/Info/");
...
function getCurrId(){
  ...
  var query = firebase.database().ref("EE");
...
function getCurrName(currNameId,i){
  ...
  var query = firebase.database().ref("EE/"+currNameId+"/Info/");
