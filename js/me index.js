...
function GeneralEducation(currNameId){
  ...
  var query = firebase.database().ref("ME/"+currNameId+"/Course/").orderByChild("Ccode");
...
function CdeleteOnClick(trKey,currNameId){
  ...
  $(document).ready(function(){
    ...
    var firebaseRef = firebase.database().ref("ME/"+currNameId+"/Course/"+trKey);
...
function MajorEducation(currNameId){
  ...
  var fragment = document.createDocumentFragment();
  var table = document.createElement("table");
  var query = firebase.database().ref("ME/"+currNameId+"/MajorCourse/").orderByChild("Ccode");
...
function MdeleteOnClick(trKey, currNameId){
  ...
  $(document).ready(function(){
    ...
    var firebaseRef = firebase.database().ref("ME/"+currNameId+"/MajorCourse/"+trKey);
...
function addCourse(){
  ...
  if(intCheck == 1){
    ...
    var firebaseRef=firebase.database().ref("ME/"+currNameIdGlobal+"/Course/");
...
function addMCourse(){
  ...
  if(intCheck == 1){
    ...
    var firebaseRef=firebase.database().ref("ME/"+currNameIdGlobal+"/MajorCourse/");
...
function addNewCurriculum(){
  ...
  if(intCheck == 1){
    ...
    var firebaseRef=firebase.database().ref("ME/"+AddCurrNameId+"/Info/");
...
function getCurrId(){
  ...
  var query = firebase.database().ref("ME");
...
function getCurrName(currNameId,i){
  ...
  var query = firebase.database().ref("ME/"+currNameId+"/Info/");
